      ...
      <Container maxWidth="md">
        <Paper elevation={3} sx={{ p: 4, mb: 4 }}>
          <Typography variant="h5" gutterBottom>
            Introduceți un URL pentru a scana imaginile fără atribut{" "}
            <code>alt</code>.
          </Typography>
          <Box
            sx={{
          ...
          {!loading &&
            (imagesWithoutAlt.length > 0 || imagesWithAlt.length > 0) && (
              <Box sx={{ mt: 4 }}>
                <Typography variant="h6">Rezultate:</Typography>
                <Typography variant="body1">
                  Total imagini găsite:{" "}
                  {imagesWithoutAlt.length + imagesWithAlt.length}
                </Typography>
                <Typography variant="body1">
